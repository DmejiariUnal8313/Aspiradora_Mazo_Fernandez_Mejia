...
class IAspirador(Ambiente):
    ...
    def verifica_estado_aspirador(self, Ambiente):
        if localizacionAspirador=="A" and Ambiente.localizacion["A"]==1:
            ...
            result2="El aspirador es colocado en el local C \n"
            Ambiente.cont +=1
            Asp.speed(10)
            Asp.setpos(-120,-240)
        elif localizacionAspirador=="C" and Ambiente.localizacion["D"]==1:
            result2="El aspirador es colocado en el local D \n"
            Ambiente.cont +=1
            Asp.speed(10)
            Asp.setpos(120,-240)
        ...
        elif localizacionAspirador=="C" and Ambiente.localizacion["C"]==0:
            result3="El lado C ya se encuentra limpio, por ende la aspiradora no se mueve \n"
            Ambiente.cont +=1
            Asp.speed(10)
            Asp.setpos(0,0)
            return print(result3)
        
        elif localizacionAspirador=="D" and Ambiente.localizacion["D"]==0:
            result4="El lado D ya se encuentra limpio, por ende la aspiradora no se mueve \n"
            Ambiente.cont +=1
            Asp.speed(10)
            Asp.setpos(0,0)
            return print(result4)
        
        elif (localizacionAspirador=="A" or localizacionAspirador=="B" or localizacionAspirador=="C" or localizacionAspirador=="D") or (Ambiente.localizacion["A"]==0 and Ambiente.localizacion["B"]==0 and Ambiente.localizacion["C"]==0 and Ambiente.localizacion["D"]==0):
            result1="Los cuatro lados ya se encuentran limpios, la aspiradora no se mueve \n"
            Ambiente.cont +=1
            Asp.speed(10)
            Asp.setpos(0,0)
            return print(result1)
    ...
    def verifica_estado_ambiente(self,Ambiente):
        # Si solo un lado estuviese sucio
        if Ambiente.localizacion["A"]==1 and Ambiente.localizacion["B"]==0 and Ambiente.localizacion["C"]==0 and Ambiente.localizacion["D"]==0:
                Ambiente.cont +=1
                print("El lado A esta sucio...")
                IAspirador.aspiraA(self,Ambiente)

        elif Ambiente.localizacion["A"]==0 and Ambiente.localizacion["B"]==1 and Ambiente.localizacion["C"]==0 and Ambiente.localizacion["D"]==0:
                Ambiente.cont +=1
                print("El lado B esta sucio...")
                IAspirador.aspiraB(self,Ambiente)
                # IAspirador.moverse(self, Ambiente)
                # print("El lado A ya esta limpio")
        elif Ambiente.localizacion["A"]==0 and Ambiente.localizacion["B"]==0 and Ambiente.localizacion["C"]==1 and Ambiente.localizacion["D"]==0:
                Ambiente.cont +=1
                print("El lado C esta sucio...")
                IAspirador.aspiraC(self,Ambiente)
                # IAspirador.moverse(self, Ambiente)
                # print("El lado A ya esta limpio")
        elif Ambiente.localizacion["A"]==0 and Ambiente.localizacion["B"]==0 and Ambiente.localizacion["C"]==0 and Ambiente.localizacion["D"]==1:
                Ambiente.cont +=1
                print("El lado D esta sucio...")
                IAspirador.aspiraD(self,Ambiente)
                # IAspirador.moverse(self, Ambiente)
                # print("El lado A ya esta limpio")
        #Si solo dos lados estuvieran sucios
        ...
        elif Ambiente.localizacion["A"]==1 and Ambiente.localizacion["B"]==1 and Ambiente.localizacion["C"]==0 and Ambiente.localizacion["D"]==0:
            if localizacionAspirador=="A":
                Ambiente.cont +=1
                print("El lado A esta sucio...")
                IAspirador.aspiraA(self,Ambiente)
        ...
        elif Ambiente.localizacion["A"]==1 and Ambiente.localizacion["B"]==0 and Ambiente.localizacion["C"]==1 and Ambiente.localizacion["D"]==0:
            if localizacionAspirador=="A":
                Ambiente.cont +=1
                print("El lado A esta sucio...")
                IAspirador.aspiraA(self,Ambiente)
        ...
        elif Ambiente.localizacion["A"]==1 and Ambiente.localizacion["B"]==0 and Ambiente.localizacion["C"]==0 and Ambiente.localizacion["D"]==1:
            if localizacionAspirador=="A":
                Ambiente.cont +=1
                print("El lado A esta sucio...")
                IAspirador.aspiraA(self,Ambiente)
        ...
        elif Ambiente.localizacion["A"]==0 and Ambiente.localizacion["B"]==1 and Ambiente.localizacion["C"]==1 and Ambiente.localizacion["D"]==0:
        ...
        elif Ambiente.localizacion["A"]==0 and Ambiente.localizacion["B"]==1 and Ambiente.localizacion["C"]==0 and Ambiente.localizacion["D"]==1:
            if localizacionAspirador=="B":
                Ambiente.cont +=1
                print("El lado B esta sucio...")
                IAspirador.aspiraB(self,Ambiente)
        ...
        elif Ambiente.localizacion["A"]==0 and Ambiente.localizacion["B"]==0 and Ambiente.localizacion["C"]==1 and Ambiente.localizacion["D"]==1:
        ...
        elif Ambiente.localizacion["A"]==0 and Ambiente.localizacion["B"]==1 and Ambiente.localizacion["C"]==1 and Ambiente.localizacion["D"]==1:
            if localizacionAspirador=="C":
                Ambiente.cont +=1
                print("El lado C esta sucio...")
                IAspirador.aspiraC(self,Ambiente)
        ...
        elif Ambiente.localizacion["A"]==1 and Ambiente.localizacion["B"]==1 and Ambiente.localizacion["C"]==1 and Ambiente.localizacion["D"]==0:
            if localizacionAspirador=="C":
                Ambiente.cont +=1
                print("El lado C esta sucio...")
                IAspirador.aspiraC(self,Ambiente)
        ...
        elif Ambiente.localizacion["A"]==1 and Ambiente.localizacion["B"]==1 and Ambiente.localizacion["C"]==0 and Ambiente.localizacion["D"]==1:
        ...
        elif Ambiente.localizacion["A"]==1 and Ambiente.localizacion["B"]==0 and Ambiente.localizacion["C"]==1 and Ambiente.localizacion["D"]==1:
            if localizacionAspirador=="C":
                Ambiente.cont +=1
                print("El lado C esta sucio...")
                IAspirador.aspiraC(self,Ambiente)
            ...
            Ambiente.cont = 0
            print("\n --- Los cuatro lados ya se encontraban limpios ---")
